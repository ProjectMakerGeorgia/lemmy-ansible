...
This provides an easy way to install [Lemmy](https://github.com/ProjectMakerGeorgia/lemmy) on any server. It automatically sets up an nginx server, letsencrypt certificates, and email.
...
```
git clone https://github.com/ProjectMakerGeorgia/lemmy-ansible.git
cd lemmy-ansible
```
...
- Run `git pull`
- Check out the [Lemmy Releases Changelog](https://github.com/ProjectMakerGeorgia/lemmy/blob/main/RELEASES.md) to see if there are any config changes with the releases since your last. 
